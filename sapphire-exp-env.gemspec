...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/Matthew238/sapphire-exp-env"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.10"
  s.summary = "An experiment environment for the prototype development of the programing language Sapphire."
